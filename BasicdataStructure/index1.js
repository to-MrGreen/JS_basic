...
*/
let yourArray =[2, true, "Tanu", "Samiul", "Haque"];// Change this line
...
function popShift(arr) {
  let a=arr;
  let popped =a.pop(a.length); // Change this line
  let shifted =a.shift(a[0]); // Change this line
...
// Only change code above this line
console.log(arr);
//splice() splice(1,5) mane holo array indext 1 theke 4 porjonto return korbe or remove korbe 

//-----Add Items Using splice()---------
//EX.  numbers.splice(startIndex, amountToDelete, 13, 14);
...
*/
//slice(1,4) mane array index 1 and 3 return korbe just new akta array te, main array kono change hbe na
//solve>>>>>>>>
...
//solve>>>>>>>> 3 level mane 2 ta bracket [[ ]], 4th level mane 3 ta brackets [[[ ]]]
let myNestedArray = [
  // change code below this line
...
This code will evaluate the value stored in the selectedFood variable and return the value of that key in the foods object, or undefined if it is not present. Bracket notation is very useful because sometimes object properties are not known before runtime or we need to access them in a more
*/
